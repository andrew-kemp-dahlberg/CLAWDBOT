...
**Location for handoffs:** `memory/`

---

## The Communication Protocol

**File:** `memory/subagent-comms.json`
...
| `frameworks/FEAR-PLAYBOOK.md` | How to handle fear |
| `memory/subagent-comms.json` | Communication hub |
| `memory/memory-1-partnership-agreement.md` | The foundation |
| `worldview/` | Grounding beliefs |
...
2. **Save your current work to a file** in `memory/`
