...
- `archive/memory/2026-02-02-2033-session-state-andrew-saved.md` - 17 broken refs to old structure
...
- `archive/memory/credentials-moltbook.md` - referenced in memory-3
...
**Rule:** Everything goes to `archive/memory/` or outputs to terminal. No /tmp, no ephemeral storage.
